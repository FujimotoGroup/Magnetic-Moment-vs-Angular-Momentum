...
# 1,3 layout -  {{{
    ...
    plt.savefig(png+"spin_conductivity1_L"+str(valley)+"-"+str(bandsL)+"bands_gamma"+label+".png", bbox_inches = 'tight', dpi=300)
    plt.rc("svg", fonttype="none")
    plt.savefig(svg+"spin_conductivity1_L"+str(valley)+"-"+str(bandsL)+"bands_gamma"+label+".svg")
    #plt.show()
    plt.close()
# }}}
# }}}
...
# 1,3 layout -  {{{
    ...
    plt.savefig(png+"spin_conductivity2_L"+str(valley)+"-"+str(bandsL)+"bands_gamma"+label+".png", bbox_inches = 'tight', dpi=300)
    plt.rc("svg", fonttype="none")
    plt.savefig(svg+"spin_conductivity2_L"+str(valley)+"-"+str(bandsL)+"bands_gamma"+label+".svg")
    #plt.show()
    plt.close()
# }}}
# }}}
...
# 1,1 layout -  {{{
    ...
    plt.savefig(png+"spin_conductivity_L"+str(valley)+"-"+str(bandsL)+"bands_compare_gamma"+label+".png", bbox_inches = 'tight', dpi=300)
    plt.rc("svg", fonttype="none")
    plt.savefig(svg+"spin_conductivity_L"+str(valley)+"-"+str(bandsL)+"bands_compare_gamma"+label+".svg")
    #plt.show()
    plt.close()
# }}}
# }}}
...
conductivity1 = total_spin_conductivity1[0] + total_spin_conductivity1[1] + total_spin_conductivity1[2]
conductivity2 = total_spin_conductivity2[0] + total_spin_conductivity2[1] + total_spin_conductivity2[2]
...
plt.savefig(png+"spin_conductivity1_L-total-"+str(bandsL)+"bands_gamma"+label+".png", bbox_inches = 'tight', dpi=300)
plt.rc("svg", fonttype="none")
plt.savefig(svg+"spin_conductivity1_L-total-"+str(bandsL)+"bands_gamma"+label+".svg")
#plt.show()
plt.close()
# }}}
...
plt.savefig(png+"spin_conductivity2_L-total-"+str(bandsL)+"bands_gamma"+label+".png", bbox_inches = 'tight', dpi=300)
plt.rc("svg", fonttype="none")
plt.savefig(svg+"spin_conductivity2_L-total-"+str(bandsL)+"bands_gamma"+label+".svg")
#plt.show()
plt.close()
# }}}
...
plt.rc("svg", fonttype="none")
plt.savefig(svg+"spin_conductivity1_L-comparison-"+str(bandsL)+"bands_gamma"+label+".svg")
#plt.show()
plt.close()
# }}}

# spin conductivity2 1,4 layout -  {{{
fig, axes = plt.subplots(1,4,figsize=(28,7))
axes = axes.flatten()
