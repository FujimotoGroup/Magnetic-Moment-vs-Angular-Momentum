...
plt.savefig(png+"dos_L-"+str(bandsL)+"bands-isotropic.png", bbox_inches = 'tight', dpi=300)
plt.rc("svg", fonttype="none")
plt.savefig(svg+"dos_L-"+str(bandsL)+"bands-isotropic.svg")
#plt.show()
plt.close()
# }}}
# }}}
...
plt.savefig(png+"conductivity_L-"+str(bandsL)+"bands-isotropic.png", bbox_inches = 'tight', dpi=300)
plt.rc("svg", fonttype="none")
plt.savefig(svg+"conductivity_L-"+str(bandsL)+"bands-isotropic.svg")
#plt.show()
plt.close()
# }}}
# 1,1 layout -  {{{
...
axes.plot(x, sigma_analytic, label="analytic")
axes.legend()

ax_pos = axes.get_position()
fig.text(ax_pos.x1 - 0.15, ax_pos.y1 + 0.1, str_damping)

plt.savefig(png+"conductivity_L-"+str(bandsT)+"bands_compare-isotropic.png", bbox_inches = 'tight', dpi=300)
plt.rc("svg", fonttype="none")
plt.savefig(svg+"conductivity_L-"+str(bandsT)+"bands_compare-isotropic.svg")
#plt.show()
plt.close()
# }}}
# }}}
...
conductivity[:,1:-1] = conductivity[:,1:-1] * coef_numeric
window = [-np.abs(conductivity[:,6].max()*1.1e0),
           np.abs(conductivity[:,6].max()*1.1e0)]
...
plt.savefig(png+"spin_conductivity1_L-"+str(bandsL)+"bands-isotropic.png", bbox_inches = 'tight', dpi=300)
plt.rc("svg", fonttype="none")
plt.savefig(svg+"spin_conductivity1_L-"+str(bandsL)+"bands-isotropic.svg")
#plt.show()
plt.close()
# }}}
# 1,1 layout -  {{{
...
plt.savefig(png+"spin_conductivity1_L-"+str(bandsL)+"bands_compare-isotropic.png", bbox_inches = 'tight', dpi=300)
plt.rc("svg", fonttype="none")
plt.savefig(svg+"spin_conductivity1_L-"+str(bandsL)+"bands_compare-isotropic.svg")
#plt.show()
plt.close()
# }}}
# }}}
...
fig, axes = plt.subplots(1,3,figsize=(21,7))
axes = axes.flatten()
readfile = data+'L1_'+str(bandsL)+'bands/spin_Hall_conductivity2_real_eps'+label+'.csv'
df = pd.read_csv(readfile,header=0)
titles = df.columns.values
conductivity = df.values
conductivity[:,1:-1] = conductivity[:,1:-1] * coef_numeric
...
plt.savefig(png+"spin_conductivity2_L-"+str(bandsL)+"bands-isotropic.png", bbox_inches = 'tight', dpi=300)
plt.rc("svg", fonttype="none")
plt.savefig(svg+"spin_conductivity2_L-"+str(bandsL)+"bands-isotropic.svg")
#plt.show()
plt.close()
# }}}
# 1,1 layout -  {{{
...
plt.savefig(png+"spin_conductivity2_L-"+str(bandsL)+"bands_compare-isotropic.png", bbox_inches = 'tight', dpi=300)
plt.rc("svg", fonttype="none")
plt.savefig(svg+"spin_conductivity2_L-"+str(bandsL)+"bands_compare-isotropic.svg")
#plt.show()
plt.close()
# }}}
# }}}
