...
#    plt.show()
    ...
    fig.tight_layout()
    plt.savefig(pdf_dir+"dos_T"+str(bandsT)+"bands_"+label_cutoff+"_gamma"+label_eps+".pdf", bbox_inches = 'tight', dpi=300)
    plt.close()
...
def dos_L(params): # dos L {{{
    ...
    for valley in np.arange(1,4):
        ...
        ax.plot(x_lower, d_lower, label="L"+str(valley)+"-"+str(lower_band_L))
        ax.plot(x_upper, d_upper, label="L"+str(valley)+"-"+str(upper_band_L))

    ax.legend()
#    plt.show()

    fig.tight_layout()
    plt.savefig(pdf_dir+"dos_L"+str(bandsL)+"bands_"+label_cutoff+"_gamma"+label_eps+".pdf", bbox_inches = 'tight', dpi=300)
    plt.close()
...
def dos(params): # individual + total dos {{{
    ...
    ax.scatter(e, dos_total, label="Total", marker=markers[2], s=70, edgecolors=colors[6], facecolor='None')

    ax.legend()
    fig.tight_layout()
    plt.savefig(pdf_dir+"dos_"+label_cutoff+"_gamma"+label_eps+".pdf", bbox_inches = 'tight', dpi=300)
    plt.close()
# }}}
...
#    plt.show()
    fig.tight_layout()
    plt.savefig(pdf_dir+"conductivity_T"+str(bandsT)+"bands_"+label_cutoff+"_gamma"+label_eps+".pdf", bbox_inches = 'tight', dpi=300)
    #plt.show()
    plt.close()
...
def electric_conductivity_L(params):# electric conductivity L {{{
    ...
    for valley in np.arange(1,4):
        ...
        for key in plot_list_conductivity_diagonal.keys():
            window_diagonal[0] = min(window_diagonal[0], sigma[:,key].min())
            window_diagonal[1] = max(window_diagonal[1], sigma[:,key].max())

        for key in plot_list_conductivity_offdiagonal.keys():
            window_offdiagonal[0] = min(window_offdiagonal[0], sigma[:,key].min())
            window_offdiagonal[1] = max(window_offdiagonal[1], sigma[:,key].max())
...
#    plt.show()
    fig.tight_layout()
    plt.savefig(pdf_dir+"conductivity_L"+str(bandsL)+"bands_"+label_cutoff+"_gamma"+label_eps+".pdf", bbox_inches = 'tight', dpi=300)
    plt.close()
...
#    plt.show()
    fig.tight_layout()
    plt.savefig(pdf_dir+"conductivity_"+label_cutoff+"_gamma"+label_eps+".pdf", bbox_inches = 'tight', dpi=300)
    plt.close()
...
#    plt.show()
    fig.tight_layout()
    plt.savefig(pdf_dir+"spin_magnetic_conductivity"+str(N)+"_T"+str(bandsT)+"bands_"+label_cutoff+"_gamma"+label_eps+".pdf", bbox_inches = 'tight', dpi=300)
    #plt.show()
    plt.close()
...
def spin_magnetic_conductivity_L(params, N):# spin magnetic conductivity L {{{
    ...
    for valley in np.arange(1,4):
        ...
        for j, plot_list in enumerate(plot_list_spin_magnetic_conductivity):
            i = 0
            for key, val in plot_list.items():
                axes[col][j].set_ylim(window[j])
                axes[col][j].scatter(conductivity[col][:,0], conductivity[col][:,key], marker=markers[i], s=70, edgecolors=colors[i], facecolor='None', label=val)
                i = i + 1
            axes[0][j].legend()
        axes[col][0].text(0.05, 0.9, "L"+str(valley), bbox=bbox, fontsize="large", transform=axes[col][0].transAxes)
...
#    plt.show()
    fig.tight_layout()
    plt.savefig(pdf_dir+"spin_magnetic_conductivity"+str(N)+"_L"+str(bandsL)+"bands_"+label_cutoff+"_gamma"+label_eps+".pdf", bbox_inches = 'tight', dpi=300)
    plt.close()
...
#    plt.show()
    fig.tight_layout()
    plt.savefig(pdf_dir+"spin_magnetic_conductivity"+str(N)+"_"+label_cutoff+"_gamma"+label_eps+".pdf", bbox_inches = 'tight', dpi=300)
    plt.close()
...
#    plt.show()
    fig.tight_layout()
    plt.savefig(pdf_dir+"spin_magnetic_conductivity_"+label_cutoff+"_gamma"+label_eps+".pdf", bbox_inches = 'tight', dpi=300)
    plt.close()
...
#    dos(params)
    electric_conductivity(params)
    total_spin_magnetic_conductivity(params)
