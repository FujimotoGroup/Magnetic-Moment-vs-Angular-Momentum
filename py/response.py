...
data = data+'L1_'+str(bandsL)+'bands/band_index4/'
...
plt.savefig(png+"dos_L1-"+str(bandsL)+"bands_gamma"+label+".png", bbox_inches = 'tight', dpi=300)
plt.rc("svg", fonttype="none")
plt.savefig(svg+"dos_L1-"+str(bandsL)+"bands_gamma"+label+".svg")
#plt.show()
plt.close()
# }}}
# }}}
...
plt.savefig(png+"conductivity_L1-"+str(bandsL)+"bands_gamma"+label+".png", bbox_inches = 'tight', dpi=300)
plt.rc("svg", fonttype="none")
plt.savefig(svg+"conductivity_L1-"+str(bandsL)+"bands_gamma"+label+".svg")
#plt.show()
plt.close()
# }}}
# }}}
...
plt.savefig(png+"spin_conductivity1_L1-"+str(bandsL)+"bands_gamma"+label+".png", bbox_inches = 'tight', dpi=300)
plt.rc("svg", fonttype="none")
plt.savefig(svg+"spin_conductivity1_L1-"+str(bandsL)+"bands_gamma"+label+".svg")
#plt.show()
plt.close()
# }}}
# }}}
...
plt.savefig(png+"spin_conductivity2_L1-"+str(bandsL)+"bands_gamma"+label+".png", bbox_inches = 'tight', dpi=300)
plt.rc("svg", fonttype="none")
plt.savefig(svg+"spin_conductivity2_L1-"+str(bandsL)+"bands_gamma"+label+".svg")
#plt.show()
plt.close()
# }}}
# }}}
...
plt.savefig(png+"spin_conductivity_L1-"+str(bandsL)+"bands_compare_gamma"+label+".png", bbox_inches = 'tight', dpi=300)
plt.rc("svg", fonttype="none")
plt.savefig(svg+"spin_conductivity_L1-"+str(bandsL)+"bands_compare_gamma"+label+".svg")
#plt.show()
plt.close()
# }}}
# }}}
